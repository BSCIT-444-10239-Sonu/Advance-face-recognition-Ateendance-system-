    ...
    def face_recog(self):
        def draw_boundray(img, classifier, scaleFactor, minNeighbors, color, text, clf):
            ...
            for (x, y, w, h) in features:
                ...
                if confidence > 75:
                    cv2.putText(
                        img, f"ID: {i}", (x, y - 110), font, scale, color, thickness
                    )
                    cv2.putText(
                        img, f"Roll: {r}", (x, y - 80), font, scale, color, thickness
                    )
                    cv2.putText(
                        img, f"Name: {n}", (x, y - 50), font, scale, color, thickness
                    )
                    cv2.putText(
                        img,
                        f"Department: {d}",
