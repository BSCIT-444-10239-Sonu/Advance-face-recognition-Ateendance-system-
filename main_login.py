...
class Login_Window:
    def __init__(self,root):
        ...
        img1 = Image.open("images/SDT_Zoom-Backgrounds_April-8_Windansea-1-logo-1.jpg")
        ...
        myname=Label(self.root,text="Devlop By: SONU YADAV DATA SCIENCE MENTOR @ PHYSICS WALLAH & IIT PATNA ",fg="red",bg="white",font=("times new roman",28,"bold"))
        ...
        #bg_lbl1.place(x=0,y=100,width=500,height=120)
        ...
        # registerbutton
        registerbtn=Button(frame,text="New User Register",command=self.rigister_window,font=("times new roman",10,"bold"),borderwidth=0,fg="white",bg="black",activeforeground="white",activebackground="black",cursor="hand2")
        registerbtn.place(x=15,y=320,width=160)

        # forgetpassbtn
        registerbtn=Button(frame,text="Forget Password",command=self.forgot_password_window,font=("times new roman",10,"bold"),borderwidth=0,fg="white",bg="black",activeforeground="white",activebackground="black",cursor="hand2")
    ...
    def login(self):
        if self.txtuser.get()=="" or self.txtpass.get()=="":
            ...
            conn=mysql.connector.connect(host="localhost",user="root",password="914202",database="mydata")
...
class Register:
    def __init__(self,root):
        ...
        b1.place(x=10,y=420,width=200,height=55)
        ...
        b1.place(x=330,y=420,width=200,height=45)
