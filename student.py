...
class Student:
    def __init__(self,root):
        ...
        # Photo sample radio variable fix
        self.var_photo_sample = StringVar()
        
        #1st image
        img=Image.open(r"D:\Face Recognition, Student Attendance System\college_images\7th.jpg")
        ...
        #2nd image
        img1=Image.open(r"D:\Face Recognition, Student Attendance System\college_images\5th.jpg")
        ...
        # 3rd image
        img2=Image.open(r"D:\Face Recognition, Student Attendance System\college_images\6th.jpg")
        ...
        #bg image
        img3=Image.open(r"D:\Face Recognition, Student Attendance System\college_images\university.jpg")
        ...
        img_left=Image.open(r"D:\Face Recognition, Student Attendance System\college_images\AdobeStock_303989091.jpeg")
        ...
        year_combo["values"]=("Select Year","2023-2026","2024-2027","2025-2028","2026-2029","2027-2030")
        ...
        #student id
        studentId_label=Label(class_Student_frame,text="StudentID:",font=("arial",13,"bold"),bg="white")
        studentId_label.grid(row=0,column=0,sticky=W,padx=10,pady=5)
        ...
        radiobtn1=ttk.Radiobutton(class_Student_frame,variable=self.var_photo_sample,text="Take Photo Sample",value="Yes")
        radiobtn1.grid(row=6,column=0)
        
        radiobtn2=ttk.Radiobutton(class_Student_frame,variable=self.var_photo_sample,text="No Photo Sample",value="No")
        ...
        img_right=Image.open(r"D:\Face Recognition, Student Attendance System\college_images\student.jpg")
        img_right=img_right.resize((720,200),Image.LANCZOS)
    ...
    def add_data(self):
        if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.var_std_id.get()=="":
            ...
            try:
                conn=mysql.connector.connect(host="localhost",username="root",password="914202",database="face_recognizer")
                ...
                my_cursor.execute("insert into student values(%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)",(
                  ...
                  self.var_photo_sample.get()   # updated
                ))
                conn.commit()
                self.fetch_data()
                conn.close()
    ...
    def get_cursor(self,event=""):
        ...
        # safe photo sample set
        self.var_photo_sample.set(data[14] if data[14] else "")
        ...
        if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.var_std_id.get()=="":
            ...
            try:
                ...
                if Update>0:
                    ...
                    my_cursor=conn.cursor()
                    my_cursor.execute("""
                    UPDATE student SET dep=%s, course=%s, year=%s, semester=%s, division=%s, roll=%s,
                    ...
                    """,(
                        ...
                        self.var_address.get(),
                        self.var_teacher.get(),
                        self.var_photo_sample.get(),  # updated variable
                        self.var_std_id.get()
                    ))
                else:
                    if not Update:
